  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: "20px" }}>
        The data, interfaces, and graphical components represented across the EZ
        Shop domain strictly act uniquely as an educational development
      ...
      <p style={{ marginBottom: "15px" }}>
        The materials spanning the EZ Shop interface may heavily include dynamic
      ...
      <p style={{ marginBottom: "15px" }}>
        EZ Shop operates completely independent domains and takes strictly zero
